...
# BOT INITIALIZATION 
activity = discord.Activity(type=discord.ActivityType.watching, name="HTOS database")
...
BOT_DISCORD_UPLOAD_LIMIT = 8 # 25 mb minimum when no nitro boosts in server (swapped to 15 for testing)
ZIPFILE_COMPRESSION_MODE = ZIP_STORED # chefinal_sizeck the imports for all modes
